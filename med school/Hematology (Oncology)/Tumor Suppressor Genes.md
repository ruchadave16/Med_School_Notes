...
source: ID
---
*genes normally stop cancer but when both normal alleles are changed, end up causing cancer*

| Gene         | Product                                                               | Condition                                         |
| ------------ | --------------------------------------------------------------------- | ------------------------------------------------- |
| APC          | Negative regulator of WNT pathway<br>Inhibits $\beta$-catenin buildup | Colorectal cancer ([[FAP]])                       |
| BRCA1/BRCA2  |                                                                       | Breast, ovarian, prostate, pancreatic cancers     |
| CDKN2A       | p16, blocks G1→ S                                                     | Many cancers                                      |
